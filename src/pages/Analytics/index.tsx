...
import { TrendingUp, TrendingDown, Clock, Users, AlertTriangle, BarChart2 } from 'lucide-react';
...
function MetricTile({ label, value, sub, icon, color, trend, trendValue }: MetricTileProps) {
